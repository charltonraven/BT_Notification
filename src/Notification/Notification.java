...
public class Notification extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage PrimaryStage) throws Exception {
        ...
        lblColon = new Label(":");
        lblComma = new Label(",");
        lblSteps = new Label("DO THE FOLLOWING PRIOR TO THE TIME OF THE DATA TRANSFER:\n1). Make sure the old and new PCs are powered on.\n2). Be sure that laptops have power adapters plugged in.\n3).Connect both of them to the network via network cable.");
        lblWarning = new Label(
                "**** Work days are Monday-Friday from 8AM to 5PM *****\n\nIf you would like to schedule your Data transfer on another week \nor\nIf you have problems connecting your PC to the network.\n\n*****Give us a call, 843-383-7050.");
        lblWarning.setStyle("-fx-font-size: 9");
        lblWarning.wrapTextProperty();
        ...
        GridPane.setConstraints(lblWarning, 0, 4);
        GridPane.setConstraints(lblSteps,0,3);
        ...
        // put on grid
        grid.getChildren().addAll(lblAsk, btnsTimeChoice, btnsSubmitCancel, lblWarning,lblSteps);
